...
path_to_dir: str = '/share/pi/nigam/mwornow/ehrshot-benchmark/EHRSHOT_ASSETS/benchmark_starr_all_labels_per_patient'
...
for folder in os.listdir(path_to_dir):
    ...
    # sampled_df = df.groupby('patient_id').apply(lambda x: x.sample(1, random_state=42)).reset_index(drop=True)
