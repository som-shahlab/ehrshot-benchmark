...
# Paths
EXPERIMENT_IDENTIFIER="markdown_serialization_demo_and_aggr"
                    ...
                    for num_aggregated_val in "${num_aggregated[@]}"; do
                        for parent_concept in "${parent_concepts[@]}"; do
                            for use_instructions in "${instructions_options[@]}"; do
                                ...
                                experiment_name="${text_encoder}_${serialization_strategy}_${excluded_ontology}_${unique_event}_${numeric_value}_${num_aggregated_val}_${DATASET}"
